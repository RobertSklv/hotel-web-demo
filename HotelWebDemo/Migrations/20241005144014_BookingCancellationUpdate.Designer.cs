...
namespace HotelWebDemo.Migrations
{
    ...
    [Migration("20241005144014_BookingCancellationUpdate")]
    partial class BookingCancellationUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.Booking", b =>
                {
                    ...
                    b.HasIndex("TotalsId")
                        .IsUnique()
                        .HasFilter("[TotalsId] IS NOT NULL");
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.BookingEventLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.BookingTotals", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("CustomGrandTotal")
                        .HasColumnType("decimal(19, 4)");
                    ...
                    b.ToTable("BookingTotals");
                });

            modelBuilder.Entity("HotelWebDemo.Models.Database.CheckedInCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CustomerCheckinInfos");
                });

            modelBuilder.Entity("HotelWebDemo.Models.Database.CheckinInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.RoomReservation", b =>
                {
                    ...
                    b.HasIndex("CheckinInfoId")
                        .IsUnique()
                        .HasFilter("[CheckinInfoId] IS NOT NULL");
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsModifier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsCategoryModifier", b =>
                {
                    b.HasBaseType("HotelWebDemo.Models.Database.TotalsModifier");
                    ...
                    b.ToTable("TotalsCategoryModifiers");
                });

            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsDiscountModifier", b =>
                {
                    b.HasBaseType("HotelWebDemo.Models.Database.TotalsModifier");

                    b.ToTable("TotalsDiscountModifiers");
                });

            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsFeatureModifier", b =>
                {
                    b.HasBaseType("HotelWebDemo.Models.Database.TotalsModifier");
                    ...
                    b.ToTable("TotalsFeatureModifiers");
                });

            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsTaxModifier", b =>
                {
                    b.HasBaseType("HotelWebDemo.Models.Database.TotalsModifier");

                    b.ToTable("TotalsTaxModifiers");
                });
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.Booking", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.BookingCancellation", "BookingCancellation")
                        .WithOne("Booking")
                        .HasForeignKey("HotelWebDemo.Models.Database.Booking", "BookingCancellationId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("HotelWebDemo.Models.Database.BookingContact", "Contact")
                        .WithOne("Booking")
                        .HasForeignKey("HotelWebDemo.Models.Database.Booking", "ContactId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("HotelWebDemo.Models.Database.BookingTotals", "Totals")
                        .WithOne("Booking")
                        .HasForeignKey("HotelWebDemo.Models.Database.Booking", "TotalsId");
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.CheckedInCustomer", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.CheckinInfo", "CheckinInfo")
                        .WithMany("CheckedInCustomers")
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.Customer", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.Address", "Address")
                        .WithOne("Customer")
                        .HasForeignKey("HotelWebDemo.Models.Database.Customer", "AddressId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.Review", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.CustomerAccount", "Author")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.RoomReservation", b =>
                {
                    ...
                    b.HasOne("HotelWebDemo.Models.Database.CheckinInfo", "CheckinInfo")
                        ...
                        .HasForeignKey("HotelWebDemo.Models.Database.RoomReservation", "CheckinInfoId");
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsCategoryModifier", b =>
                {
                    ...
                    b.HasOne("HotelWebDemo.Models.Database.TotalsModifier", null)
                        .WithOne()
                        .HasForeignKey("HotelWebDemo.Models.Database.TotalsCategoryModifier", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsDiscountModifier", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.TotalsModifier", null)
                        .WithOne()
                        .HasForeignKey("HotelWebDemo.Models.Database.TotalsDiscountModifier", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsFeatureModifier", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.RoomFeature", "Feature")
                        .WithMany()
                    ...
                    b.HasOne("HotelWebDemo.Models.Database.TotalsModifier", null)
                        .WithOne()
                        .HasForeignKey("HotelWebDemo.Models.Database.TotalsFeatureModifier", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.TotalsTaxModifier", b =>
                {
                    b.HasOne("HotelWebDemo.Models.Database.TotalsModifier", null)
                        .WithOne()
                        .HasForeignKey("HotelWebDemo.Models.Database.TotalsTaxModifier", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HotelWebDemo.Models.Database.CheckinInfo", b =>
                {
                    b.Navigation("CheckedInCustomers");
